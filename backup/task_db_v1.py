...
def get_tasks_from_db(start_date: Optional[str] = None, end_date: Optional[str] = None) -> Dict[str, List[Dict[str, Any]]]:
    ...
    try:
        if start_date and end_date:
            ...
            cursor.execute("""
                SELECT record_id, task_name, assignee, status, date, start_date, end_date, weekday 
                FROM tasks 
        ...
        for row in rows:
            record_id, task_name, assignee, status, date, start_date, end_date, weekday = row
            task_item = {
                "record_id": record_id,
                "task_name": task_name,
                "assignee": assignee,
